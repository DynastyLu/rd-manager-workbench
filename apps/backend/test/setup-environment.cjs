...
process.env.PORT = '0'
process.env.DATABASE_ADMIN_URL = 'postgresql://dynastylu@127.0.0.1:5432/postgres'
process.env.DATABASE_URL =
  'postgresql://rd_manager_workbench_app@127.0.0.1:5432/rd_manager_workbench_test?schema=app'
process.env.DATABASE_NAME = 'rd_manager_workbench_test'
process.env.DATABASE_ROLE = 'rd_manager_workbench_app'
